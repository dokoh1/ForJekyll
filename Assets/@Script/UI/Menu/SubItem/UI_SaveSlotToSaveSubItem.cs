...
public class UI_SaveSlotToSaveSubItem : UI_SubItem
{
	private enum Texts
	{
		Description,
	...
	{
		UI_SavePopup savePopup = PManagers.DarkUI.ShowPopupUI<UI_SavePopup>();
		savePopup.OnContinueAction = OnEnable;
		savePopup.ModalWindowIn();
		PushData();
	}
	...
	public void OnEnable()
	{
		...
		button.interactable = slotNum != 10;
